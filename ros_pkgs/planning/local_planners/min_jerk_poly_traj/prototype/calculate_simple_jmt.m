function [frenet_path] = calculate_simple_jmt(start_frenet_state, goal_frenet_state)
 ...
 for iter_dt = 0 : dt : t
   s_iter = evaluate_poly([s0,s0_dot, s0_ddot],[sf, sf_dot, sf_ddot], coeffs_s,iter_dt,t);
   d_iter = evaluate_poly([d0,d0_dot, d0_ddot],[df, df_dot, df_ddot],coeffs_d,iter_dt,t);
